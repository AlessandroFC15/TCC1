...
from algorithms.data_imputation.DataImputation import MeanImputation, KNNImputation, KNNImputation_7, InterpolationImputation
import scipy
...
imputation_strategies = [KNNImputation_7]
