...
def save_features_to_csv_file(missing_data_percentage, num_iterations=1):
    ...
    for i in range(num_iterations):
        ...
        for j, filename in enumerate(files):
            ...
            extracted_data.append(extract_features(files_directory + filename, missing_data_percentage))

        print(">> Criando arquivo csv...")

        with open(
                '/home/alessandro/Documentos/Programming/Projects/TCC1/algorithms/features/Features_Originais_Hora_12_Sensor_5_MDP_{}_{}.csv'.format(
                    missing_data_percentage, i), 'w') as csvfile:
